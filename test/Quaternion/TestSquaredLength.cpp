...
struct QuatSquaredLengthTestData
{
    Quaternion4f p4f;
};

DEFINE_TEST_TYPES(QuatSquaredLengthTestData);
...
void TestRegistry::test<1>()
{
    ...
    set_test_name("SquaredLength (Quaternion)");
    
    float result = jship::Hazmat::SquaredLength(p4f);
    ...
    result = jship::Hazmat::SquaredLength(p4f);
