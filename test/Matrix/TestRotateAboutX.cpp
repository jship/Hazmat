...
DEFINE_TEST_TYPES(RotateAboutXTestData);
...
{
    set_test_name("RotateAboutX (4x4 matrix)");
    ...
    jship::Hazmat::RotateAboutX(a4f, radians, b4f);
    ...
    DOUBLES_EQUAL(b4f[ 0],                  2.0f, 1e-5);
    DOUBLES_EQUAL(b4f[ 1],   3.0f * c - 4.0f * s, 1e-5);
    DOUBLES_EQUAL(b4f[ 2],   4.0f * c + 3.0f * s, 1e-5);
    DOUBLES_EQUAL(b4f[ 3],                  5.0f, 1e-5);
    DOUBLES_EQUAL(b4f[ 4],                  6.0f, 1e-5);
    DOUBLES_EQUAL(b4f[ 5],   7.0f * c - 8.0f * s, 1e-5);
    DOUBLES_EQUAL(b4f[ 6],   8.0f * c + 7.0f * s, 1e-5);
    DOUBLES_EQUAL(b4f[ 7],                  9.0f, 1e-5);
    DOUBLES_EQUAL(b4f[ 8],                 10.0f, 1e-5);
    DOUBLES_EQUAL(b4f[ 9], 11.0f * c - 12.0f * s, 1e-5);
    DOUBLES_EQUAL(b4f[10], 12.0f * c + 11.0f * s, 1e-5);
    DOUBLES_EQUAL(b4f[11],                 13.0f, 1e-5);
    DOUBLES_EQUAL(b4f[12],                 14.0f, 1e-5);
    DOUBLES_EQUAL(b4f[13], 15.0f * c - 16.0f * s, 1e-5);
    DOUBLES_EQUAL(b4f[14], 16.0f * c + 15.0f * s, 1e-5);
    DOUBLES_EQUAL(b4f[15],                 17.0f, 1e-5);
    
    jship::Hazmat::RotateAboutX(a4f, radians, a4f);
    
    DOUBLES_EQUAL(a4f[ 0],                  2.0f, 1e-5);
    DOUBLES_EQUAL(a4f[ 1],   3.0f * c - 4.0f * s, 1e-5);
    DOUBLES_EQUAL(a4f[ 2],   4.0f * c + 3.0f * s, 1e-5);
    DOUBLES_EQUAL(a4f[ 3],                  5.0f, 1e-5);
    DOUBLES_EQUAL(a4f[ 4],                  6.0f, 1e-5);
    DOUBLES_EQUAL(a4f[ 5],   7.0f * c - 8.0f * s, 1e-5);
    DOUBLES_EQUAL(a4f[ 6],   8.0f * c + 7.0f * s, 1e-5);
    DOUBLES_EQUAL(a4f[ 7],                  9.0f, 1e-5);
    DOUBLES_EQUAL(a4f[ 8],                 10.0f, 1e-5);
    DOUBLES_EQUAL(a4f[ 9], 11.0f * c - 12.0f * s, 1e-5);
    DOUBLES_EQUAL(a4f[10], 12.0f * c + 11.0f * s, 1e-5);
    DOUBLES_EQUAL(a4f[11],                 13.0f, 1e-5);
    DOUBLES_EQUAL(a4f[12],                 14.0f, 1e-5);
    DOUBLES_EQUAL(a4f[13], 15.0f * c - 16.0f * s, 1e-5);
    DOUBLES_EQUAL(a4f[14], 16.0f * c + 15.0f * s, 1e-5);
