...
DEFINE_TEST_TYPES(CofactorTestData);
...
void TestRegistry::test<1>()
{
    ...
    DOUBLES_EQUAL(b2f[1], -1.0, 1e-5);
    DOUBLES_EQUAL(b2f[2], -4.0, 1e-5);
    DOUBLES_EQUAL(b2f[3],  3.0, 1e-5);
    
    jship::Hazmat::Cofactor(a2f, a2f);
...
{
    set_test_name("Cofactor (4x4 matrix)");
    ...
    DOUBLES_EQUAL(b4f[ 1], -68.0, 1e-5);
    DOUBLES_EQUAL(b4f[ 2],  74.0, 1e-5);
    DOUBLES_EQUAL(b4f[ 3],  48.0, 1e-5);
    DOUBLES_EQUAL(b4f[ 4],  16.0, 1e-5);
    DOUBLES_EQUAL(b4f[ 5],  64.0, 1e-5);
    DOUBLES_EQUAL(b4f[ 6], -16.0, 1e-5);
    DOUBLES_EQUAL(b4f[ 7], -96.0, 1e-5);
    DOUBLES_EQUAL(b4f[ 8], -30.0, 1e-5);
    DOUBLES_EQUAL(b4f[ 9],  36.0, 1e-5);
    DOUBLES_EQUAL(b4f[10], -42.0, 1e-5);
    DOUBLES_EQUAL(b4f[11],  48.0, 1e-5);
    DOUBLES_EQUAL(b4f[12],  36.0, 1e-5);
    DOUBLES_EQUAL(b4f[13], -24.0, 1e-5);
    DOUBLES_EQUAL(b4f[14],  12.0, 1e-5);
    DOUBLES_EQUAL(b4f[15],   0.0, 1e-5);
    
    jship::Hazmat::Cofactor(a4f, a4f);
    
    DOUBLES_EQUAL(a4f[ 0],  -2.0, 1e-5);
    DOUBLES_EQUAL(a4f[ 1], -68.0, 1e-5);
    DOUBLES_EQUAL(a4f[ 2],  74.0, 1e-5);
    DOUBLES_EQUAL(a4f[ 3],  48.0, 1e-5);
    DOUBLES_EQUAL(a4f[ 4],  16.0, 1e-5);
    DOUBLES_EQUAL(a4f[ 5],  64.0, 1e-5);
    DOUBLES_EQUAL(a4f[ 6], -16.0, 1e-5);
    DOUBLES_EQUAL(a4f[ 7], -96.0, 1e-5);
    DOUBLES_EQUAL(a4f[ 8], -30.0, 1e-5);
    DOUBLES_EQUAL(a4f[ 9],  36.0, 1e-5);
    DOUBLES_EQUAL(a4f[10], -42.0, 1e-5);
    DOUBLES_EQUAL(a4f[11],  48.0, 1e-5);
    DOUBLES_EQUAL(a4f[12],  36.0, 1e-5);
    DOUBLES_EQUAL(a4f[13], -24.0, 1e-5);
    DOUBLES_EQUAL(a4f[14],  12.0, 1e-5);
